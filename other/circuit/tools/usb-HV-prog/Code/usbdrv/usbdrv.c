...
#define USB_CFG_DESCR_PROPS_STRING_1    sizeof(usbDescriptorString1)
PROGMEM char usbDescriptorString1[] = {
		0x18, 0x03, 0x7a, 0x00, 0x68, 0x00, 0x69, 0x00,
		0x66, 0x00, 0x65, 0x00, 0x6e, 0x00, 0x67, 0x00,
		0x73, 0x00, 0x6f, 0x00, 0x66, 0x00, 0x74, 0x00,
};
#define USB_CFG_DESCR_PROPS_STRING_2    sizeof(usbDescriptorString2)
PROGMEM char usbDescriptorString2[] = {
		0x0e, 0x03, 0x55, 0x00, 0x53, 0x00, 0x42, 0x00,
		0x70, 0x00, 0x72, 0x00, 0x67, 0x00, 
};
#endif
                ...
                if(rq->bRequest == USBRQ_GET_STATUS){           /* 0 */
                    ...
                    if(rq->wValue.bytes[1] == USBDESCR_DEVICE){ /* 1 */
                        ...
                        if(rq->wValue.bytes[0] == 0){   /* descriptor index */
                            ...
                            GET_DESCRIPTOR(USB_CFG_DESCR_PROPS_STRING_1, usbDescriptorString1)
                        }else if(rq->wValue.bytes[0] == 2){
                            GET_DESCRIPTOR(USB_CFG_DESCR_PROPS_STRING_2, usbDescriptorString2)
