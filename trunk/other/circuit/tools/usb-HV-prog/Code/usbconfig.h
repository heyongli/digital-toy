...
#define  USB_CFG_VENDOR_ID  0xeb, 0x03  /* 5824 in dec, stands for VOTI */
/* USB vendor ID for the device, low byte first. If you have registered your
 * own Vendor ID, define it here. Otherwise you use obdev's free shared
 * VID/PID pair. Be sure to read USBID-License.txt for rules!
 */
#define USB_CFG_DEVICE_ID   0xb4, 0xc7  /* 1500 in dec, obdev's free PID */
 ...
 */
#define	USB_CFG_VENDOR_NAME     'w','w','w','.','z','h','i','f','e','n','g','s','o','f','t','.','c','o','m'
 ...
 * details.
 */
#define	USB_CFG_DEVICE_NAME		'U', 'S', 'B', 'p', 'r', 'g'
